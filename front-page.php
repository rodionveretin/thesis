   ...
   <section class="product-block">
      <div class="container">
         <div class="product-block__header">
            ...
            <div class="product-block__link"><a href="<?php echo get_home_url() . "/top" ?>">Все товары</a></div>
         </div>
               ...
               <div class="product-block__item product-card" data-id="<?php echo $products[$product]->get_id(); ?>">
                  <div class="product-card__top">
                     ...
                     <div class="product-card__img">
                        <a href="<?php echo $products[$product]->get_permalink(); ?>">
                           <?php if ($products[$product]->get_image_id()) : ?>
                              <img src="<?php echo wp_get_attachment_url($products[$product]->get_image_id()); ?>" alt="<?php echo $products[$product]->get_name(); ?>" />
                           <?php else : ?>
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/img/placeholder.png" alt="<?php echo $products[$product]->get_name(); ?>" />
                           <?php endif; ?>
                        </a>
                     </div>
                     ...
                     <div class="product-card__interactions interactions">
                        ...
                        if (is_user_logged_in()) :
                           ...
                           if (metadata_exists('user', get_current_user_id(), 'favorite')) {
                              ...
                              $product_id = $products[$product]->get_id();
                              $favorite = in_array($product_id, $arr);
                           }
                        ?>
                           <div class="interactions__favourites favorites-button" title="Добавить в избранное">
                              <a href="#">
   ...
   <section class="product-block">
      <div class="container">
         <div class="product-block__header">
            ...
            <div class="product-block__link"><a href="<?php echo get_home_url() . "/new-products" ?>">Все товары</a></div>
         </div>
         <!-- /.product-block__header -->
         <div class="product-block__wrapper">
            <?php for ($product = 0; $product < count($products); $product++) : ?>
