               ...
               <div class="product-block__item product-card" data-id="<?php echo $products[$product]->get_id(); ?>">
                  ...
                  <div class="product-card__bottom">
                     ...
                     <div class="product-card__interactions interactions">
                        ...
                        <?php if ($products[$product]->get_type() == 'grouped' || $products[$product]->get_type() == 'variable') : ?>

                           <div class="interactions__lens" title="Выберите параметры товара">
                              <a href="<?php echo $products[$product]->get_permalink(); ?>" target="_blank">
                                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13 19C8.58172 19 5 15.4183 5 11C5 6.58172 8.58172 3 13 3C17.4183 3 21 6.58172 21 11C21 15.4183 17.4183 19 13 19Z" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M2.99998 21L7.34998 16.65" stroke="#FFFFFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                 </svg>
                              </a>
                           </div>
