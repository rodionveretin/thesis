...
<div class="product-block__item product-card" data-id="<?php echo $product->get_id(); ?>">
	<div class="product-card__top">
		<?php $dateCreated = $product->get_date_created()->format('Y-m-d');
		...
		<div class="product-card__category"><a href="#"><?php echo $product->get_categories(); ?></a></div>
		<div class="product-card__title" title="<?php echo $product->get_name(); ?>">
		...
		<div class="product-card__interactions interactions">
			<div class="interactions__prices prices">
				...
				<?php elseif ($product->get_type() == 'variable') : ?>
					<span class="prices__new">От <?php echo $product->get_variation_price('min', true); ?> ₽</span>
